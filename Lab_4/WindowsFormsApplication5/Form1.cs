...
namespace WindowsFormsApplication5
{
    public partial class Form1 : Form
    {
        ...
        private void calculateGam()
        {
            MinGamilton.MinGamilton gam = new MinGamilton.MinGamilton();
            List<Vertex> way = gam.getMinGamWay(_graph);
            MinGamilton.AdjacencyMatrix m = new MinGamilton.AdjacencyMatrix(_graph);
            int w = m.getWeight(way);
